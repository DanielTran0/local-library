...
AuthorSchema.virtual('lifespan').get(function () {
	...
	if (this.date_of_death === undefined) death = new Date();
...
AuthorSchema.virtual('birth_formatted_calendar').get(function () {
	return this.date_of_birth
		? DateTime.fromJSDate(this.date_of_birth).toISODate()
		: '';
});

AuthorSchema.virtual('death_formatted_calendar').get(function () {
	return this.date_of_death
